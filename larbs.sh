...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/alimbaga/brownrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/alimbaga/LARBS/master/progs.csv"
